(() => {
  ...
  function cityDeskMain() { return `<section class="map-panel panel"><header class="section-head map-head"><div><span class="kicker">PRIMARY NEWS ENTRY</span><h2>S城都市新闻地图</h2></div><div class="map-legend"><span><i class="new-key"></i>NEW · 可查询新信息</span><span><i class="metro-key"></i>城市轨道</span></div></header><div class="city-map" id="cityMap"><div class="region-layer">${regionLayer()}</div><div class="water s-bay" aria-label="S湾水域"></div><div class="water east-coast"><b>东湾海岸</b><small>EAST BAY COAST</small></div><div class="river"><span>青川河</span></div><div class="road road-axis"><span>城市中轴大道</span></div><div class="road road-bay"><span>滨湾大道</span></div><div class="road road-east"><span>东部快速路</span></div><div class="metro metro-1"><span>1</span></div><div class="metro metro-2"><span>2</span></div><div class="metro metro-3"><span>3</span></div><div id="locationLayer">${mapNodes()}</div><div class="north">N<br>↑</div></div><footer class="map-caption"><span>地图是本轮唯一主要信息入口</span><span>点击 NEW 地点，新增信息才会进入左栏</span></footer></section>`; }
